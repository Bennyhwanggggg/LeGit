...
perl legit.pl add $test_file_1 $test_file_2 $test_file_3 
perl legit.pl commit -m 'commit 1' 
perl legit.pl rm --force $test_file_2 
perl legit.pl status 
perl legit.pl log 
echo another >> $test_file_1
perl legit.pl add $test_file_1 $test_file_2 $test_file_3 
perl legit.pl add $test_file_1 $test_file_3 
perl legit.pl commit -m commit02 
perl legit.pl status 
perl legit.pl rm --cached $test_file_3 
perl legit.pl status 
perl legit.pl rm $test_file_3 
perl legit.pl rm --force $test_file_3 
